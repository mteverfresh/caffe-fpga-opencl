...
# Board skews
set board(abs_max_CK_delay) 1.3667614
set board(abs_max_DQS_delay) 0.63599095
set board(minCK_DQS_skew) 0.0
set board(maxCK_DQS_skew) 0.0
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.004431906023
set board(inter_DQS_group_skew) 0.0900671275
set board(DQ_DQS_skew) -9.89612034E-4
set board(intra_addr_ctrl_skew) 0.008250985034
set board(addresscmd_CK_skew) -2.7541739E-5
