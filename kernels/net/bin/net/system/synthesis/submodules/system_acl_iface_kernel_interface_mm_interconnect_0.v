// system_acl_iface_kernel_interface_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module system_acl_iface_kernel_interface_mm_interconnect_0 (
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_router router (
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_router_001 router_001 (
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (kernel_clk_out_clk_clk),                                    //       clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (kernel_clk_out_clk_clk),                       //       clk.clk
		.reset               (kernel_cra_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (kernel_clk_out_clk_clk),                            //       clk.clk
		.reset              (kernel_cra_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	system_acl_iface_kernel_interface_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (kernel_clk_out_clk_clk),                                    //       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
