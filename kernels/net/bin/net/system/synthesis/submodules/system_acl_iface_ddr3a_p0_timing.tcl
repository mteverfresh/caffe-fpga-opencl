...
# Board skews
set board(abs_max_CK_delay) 1.344965382
set board(abs_max_DQS_delay) 0.6220263175
set board(minCK_DQS_skew) 0.0
set board(maxCK_DQS_skew) 0.0
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.006914298045
set board(inter_DQS_group_skew) 0.091996905
set board(DQ_DQS_skew) -8.58383134E-4
set board(intra_addr_ctrl_skew) 0.01654451376
set board(addresscmd_CK_skew) -0.001268865261
